...
/*! \file filewriter.h
    \brief Provides an API very similar to fwrite and friends but uses a directory that provides persistent file storage. This can later be read
   using the kore_file_reader-functions and KORE_FILE_TYPE_SAVE.
*/
