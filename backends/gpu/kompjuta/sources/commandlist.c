...
void kore_kompjuta_command_list_draw_indexed(kore_gpu_command_list *list, uint32_t index_count, uint32_t instance_count, uint32_t first_index,
	...
	command->data.draw_indexed.stack_top      = (uint64_t)list->kompjuta.shader_stack + list->kompjuta.shader_stack_size;
...
void kore_kompjuta_command_list_copy_buffer_to_buffer(kore_gpu_command_list *list, kore_gpu_buffer *source, uint64_t source_offset,
