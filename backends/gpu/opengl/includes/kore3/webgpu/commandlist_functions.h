#ifndef KORE_OPENGL_COMMANDLIST_FUNCTIONS_HEADER
#define KORE_OPENGL_COMMANDLIST_FUNCTIONS_HEADER
...
void kore_opengl_command_list_draw(kore_gpu_command_list *list, uint32_t vertex_count, uint32_t instance_count, uint32_t first_vertex, uint32_t first_instance);

void kore_opengl_command_list_draw_indexed(kore_gpu_command_list *list, uint32_t index_count, uint32_t instance_count, uint32_t first_index, int32_t base_vertex,
