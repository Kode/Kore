...
void ConstantBuffer::setFloat2(int offset, Kore::vec2 value) {
...
void ConstantBuffer::setFloat3(int offset, Kore::vec3 value) {
...
void ConstantBuffer::setFloat4(int offset, Kore::vec4 value) {
...
void ConstantBuffer::setMatrix(int offset, const Kore::mat3 &value) {
...
void ConstantBuffer::setMatrix(int offset, const Kore::mat4 &value) {
